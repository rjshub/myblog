    ...
    $(function(){
        $('.box').fullpage({
            ...
            afterLoad:function(anchorLink,index){
                console.log(index)
                if(index==1){
                    $(".section01").find(".sec-ch-01").animate({top:"150",opacity:"1"},50,'easeOutExpo')
                    $(".section01").find(".sec-ch-02").animate({top:"0",opacity:"1"},50,'easeOutExpo')
                    $(".section01").find(".text01").animate({top:"360",opacity:"1"},50,'easeOutExpo')
                ...
                if(index==3){
                    ...
                    $(".sec03-min04").animate({left:"-90",opacity:"1"},1000,'easeOutExpo');
                    $(".sec03-min05").animate({left:"839",opacity:"1"},1000,'easeOutExpo');
                ...
                if(index==4){
                    ...
                    $(".sec04-min03").animate({left:"30",opacity:"1"},100,'easeOutExpo');
                    $(".sec04-min04").animate({top:"304",opacity:"1"},1000,'easeOutExpo');
                    $(".sec04-min05").animate({top:"403",opacity:"1"},1000,'easeOutExpo');
                    $(".sec04-min06").animate({left:"504",opacity:"1"},1000,'easeOutExpo');
                }
                if(index==5){
                    $(".sec05-min01").animate({top:"138",opacity:"1"},100,'easeOutExpo');
                    $(".sec05-min02").animate({top:"188",opacity:"1"},100,'easeOutExpo');
                    $(".sec05-min03").animate({left:"267",opacity:"1"},100,'easeOutExpo');
                    $(".sec05-min04").animate({top:"300",opacity:"1"},3000,'easeOutExpo');
                    $(".sec05-min05").animate({top:"367",opacity:"1"},1000,'easeOutExpo');
                }
                if(index==6){
                    $(".sec06-min01").animate({top:"144",opacity:"1"},100,'easeOutExpo');
                    $(".sec06-min02").animate({top:"198",opacity:"1"},100,'easeOutExpo');
                    $(".sec06-min03").animate({left:"-3",opacity:"1"},1000,'easeOutExpo');
                    $(".sec06-min04").animate({left:"279",opacity:"1"},1000,'easeOutExpo');
                    $(".sec06-min05").animate({left:"562",opacity:"1"},1000,'easeOutExpo');
                    $(".sec06-min06").animate({left:"838",opacity:"1"},1000,'easeOutExpo');
            ...
            onLeave: function(index, direction){
                ...
                if(index==3){
                    ...
                    $(".sec03-min04").delay(300).animate({left:"150",opacity:"0"},1000,'easeOutExpo');
                    $(".sec03-min05").delay(300).animate({left:"700",opacity:"0"},1000,'easeOutExpo');
                ...
                if(index==4){
                    ...
                    $(".sec04-min03").delay(300).animate({left:"100",opacity:"0"},1000,'easeOutExpo');
                    $(".sec04-min04").animate({top:"314",opacity:"0"},1000,'easeOutExpo');
                    $(".sec04-min05").animate({top:"423",opacity:"0"},1000,'easeOutExpo');
                    $(".sec04-min06").animate({left:"304",opacity:"0"},1000,'easeOutExpo');
                }
                if(index==5){
                    $(".sec05-min01").animate({top:"118",opacity:"0"},1000,'easeOutExpo');
                    $(".sec05-min02").animate({top:"168",opacity:"0"},1000,'easeOutExpo');
                    $(".sec05-min03").animate({left:"247",opacity:"0"},1000,'easeOutExpo');
                    $(".sec05-min04").animate({top:"260",opacity:"0"},1000,'easeOutExpo');
                    $(".sec05-min05").animate({top:"327",opacity:"0"},1000,'easeOutExpo');
                }
                if(index==6){
                    $(".sec06-min01").animate({top:"124",opacity:"0"},1000,'easeOutExpo');
                    $(".sec06-min02").animate({top:"178",opacity:"0"},100,'easeOutExpo');
                    $(".sec06-min03").animate({left:"20",opacity:"0"},1000,'easeOutExpo');
                    $(".sec06-min04").animate({left:"299",opacity:"0"},1000,'easeOutExpo');
                    $(".sec06-min05").animate({left:"542",opacity:"0"},1000,'easeOutExpo');
                    $(".sec06-min06").animate({left:"818",opacity:"0"},1000,'easeOutExpo');
